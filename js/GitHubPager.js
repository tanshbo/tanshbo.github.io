(function(global){
	...
	var ArticleView=Backbone.View.extend({
		...
		{
			var disqus_shortname = settings.get("diqusId");
			if(disqus_shortname==undefined||disqus_shortname==''||disqus_shortname==null) return;
			disqus_identifier = "http://"+settings.get("domain")+'/'+currentSinglePageId
		        disqus_url = "http://"+settings.get("domain")+'/'+currentSinglePageId;
